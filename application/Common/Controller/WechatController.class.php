...
class WechatController extends Controller {
    ...
    function getCode(){
        ...
        $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.C('WE_APPID').'&redirect_uri=' . urlencode($redirect) . '&response_type=code&scope=SCOPE&state=STATE#wechat_redirect';
