...
function SelCity(a,t){var i=a;Iput.show({id:i,event:t,content:'<div class="_citys"><span title="关闭" id="cColse" >×</span><ul id="_citysheng" class="_citys0"><li class="citySel">省份</li><li>城市</li></ul><div id="_citys0" class="_citys1"></div><div style="display:none" id="_citys1" class="_citys1"></div></div>',width:"470"}),$("#cColse").click(function(){Iput.colse()});for(var e=[],s=province,d=0,l=s.length;d<l;d++)e.push('<a data-level="0" data-id="'+s[d].id+'" data-name="'+s[d].name+'">'+s[d].name+"</a>");$("#_citys0").append(e.join("")),$("#_citys0 a").click(function(){var a=getCity($(this));$("#_citys1 a").remove(),$("#_citys1").append(a),$("._citys1").hide(),$("._citys1:eq(1)").show(),$("#_citys0 a,#_citys1 a,#_citys2 a").removeClass("AreaS"),$(this).addClass("AreaS");var t=$(this).data("name");if(i.value=$(this).data("name"),null==document.getElementById("hcity")){var e=$("<input>",{type:"hidden",name:"hcity","data-id":$(this).data("id"),id:"hcity",val:t});$(i).after(e)}else $("#hcity").val(t),$("#hcity").attr("data-id",$(this).data("id"));$("#_citys1 a").click(function(){$("#_citys1 a,#_citys2 a").removeClass("AreaS"),$(this).addClass("AreaS");var a=$(this).data("name");if(null==document.getElementById("hproper")){var t=$("<input>",{type:"hidden",name:"hproper","data-id":$(this).data("id"),id:"hproper",val:a});$(i).after(t)}else $("#hproper").attr("data-id",$(this).data("id")),$("#hproper").val(a);var e=$("#hcity").val();i.value=e+"-"+$(this).data("name");var s=getArea($(this));$("#_citys2 a").remove(),$("#_citys2").append(s),$("._citys1").hide(),Iput.colse()})}),$("#_citysheng li").click(function(){$("#_citysheng li").removeClass("citySel"),$(this).addClass("citySel");var a=$("#_citysheng li").index(this);$("._citys1").hide(),$("._citys1:eq("+a+")").show()})}function getCity(a){for(var t,i=a.data("id"),e=province,s="",d=0,l=e.length;d<l;d++)if(e[d].id==parseInt(i)){t=e[d].city;break}for(var c=0,n=t.length;c<n;c++)s+='<a data-level="1" data-id="'+t[c].id+'" data-name="'+t[c].name+'" title="'+t[c].name+'">'+t[c].name+"</a>";return $("#_citysheng li").removeClass("citySel"),$("#_citysheng li:eq(1)").addClass("citySel"),s}function getArea(a){for(var t=a.data("id"),i=area,e=[],s="",d=0,l=i.length;d<l;d++)i[d].pid==parseInt(t)&&e.push(i[d]);for(var c=0,n=e.length;c<n;c++)s+='<a data-level="1" data-id="'+e[c].id+'" data-name="'+e[c].name+'" title="'+e[c].name+'">'+e[c].name+"</a>";return $("#_citysheng li").removeClass("citySel"),$("#_citysheng li:eq(2)").addClass("citySel"),s}